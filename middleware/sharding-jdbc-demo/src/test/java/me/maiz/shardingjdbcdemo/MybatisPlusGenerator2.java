...
public class MybatisPlusGenerator2 {
    //修改此处的包路径，注意：是到模块上一级
    public static final String PACKAGE_NAME = "com.demall.user.infra";
    public static final String PROJECT_INFRA_MODULE = "/user-infra";

    public static final String PROJECT_APP_MODULE = "/user-app";
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(ds.get("url"), ds.get("username"), ds.get("password"))
                .globalConfig(builder -> builder
                        .author("Lucas")
                        .outputDir(Paths.get(System.getProperty("user.dir")) + PROJECT_INFRA_MODULE +"/src/main/java")
                ...
                .packageConfig(builder -> builder
                        ...
                        //设置xml到resources位置
                        .pathInfo(Collections.singletonMap(OutputFile.xml, System.getProperty("user.dir") +PROJECT_INFRA_MODULE + "/src/main/resources/mapper"))
                )
                .strategyConfig((scanner, builder) -> builder
                        ...
                        .controllerBuilder().disable()//禁用生成controller
                        .entityBuilder()
                        .enableLombok()
    ...
    private static Map<String, String> parseDataSourceFormYml() {
        ...
        String path = Paths.get(System.getProperty("user.dir")) + PROJECT_APP_MODULE + "/src/main/resources/application.yml";
