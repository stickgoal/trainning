...
public class Config {
	...
	public final static String LOGO_IMG = "src/main/resources/images/logo.png";
	public final static String SHOOT_BACKGROUND_IMG = "src/main/resources/images/shoot_background.png";
	public final static String SHOOT_IMG = "src/main/resources/images/shoot.png";
	public final static String FONT_IMG = "src/main/resources/images/font.png";
	public final static String BUTTON_BG_IMG = "src/main/resources/images/button_bg.png";
	public final static String BUTTON_HOVER_BG_IMG = "src/main/resources/images/button_hover_bg.png";

	public final static String ACHIEVEMENT_AUDIO = "src/main/resources/sound/achievement.wav";

	public final static String SMALL_PLANE_KILLED_AUDIO = "src/main/resources/sound/small_plane_killed.wav";
	public final static String BIG_PLANE_KILLED_AUDIO = "src/main/resources/sound/big_plane_killed.wav";
	public final static String BOSS_PLANE_KILLED_AUDIO = "src/main/resources/sound/boss_plane_killed.wav";

	public final static String BOSS_PLANE_FLYING_AUDIO = "src/main/resources/sound/boss_plane_flying.wav";
	public final static String POP_WEAPON_AUDIO = "src/main/resources/sound/pop_weapon.wav";

	public final static String USER_BOMB_AUDIO = "src/main/resources/sound/use_bomb.wav";
	public final static String FIRE_BULLET_AUDIO = "src/main/resources/sound/fire_bullet.wav";

	public final static String GAME_MUSIC_AUDIO = "src/main/resources/sound/game_music.wav";
	public final static String GAME_OVER_AUDIO = "src/main/resources/sound/game_over.wav";

	public final static String GET_BOMB_AUDIO = "src/main/resources/sound/get_bomb.wav";
	public final static String GET_DOUBLE_LASER_AUDIO = "src/main/resources/sound/get_double_laser.wav";

	public final static String BUTTON_ACTION_AUDIO = "src/main/resources/sound/button.wav";
	...
	public final static int SMALL_PLANE_STATUS_CHANGE_INTERVAL = 40;
