...
public class PostController {
    ...
    private static final  List<Post> posts = new ArrayList<>();
       static {
           ...
           posts.add(new Post(2,"huawei新机鉴赏","我们一起来鉴赏华为的P30","一线新机",new Date()));
           posts.add(new Post(3,"huawei新机鉴赏","我们一起来鉴赏华为的P30","一线新机",new Date()));
           posts.add(new Post(4,"huawei新机鉴赏","我们一起来鉴赏华为的P30","一线新机",new Date()));
           posts.add(new Post(5,"huawei新机鉴赏","我们一起来鉴赏华为的P30","一线新机",new Date()));
           posts.add(new Post(6,"huawei新机鉴赏","我们一起来鉴赏华为的P30","一线新机",new Date()));
       }
