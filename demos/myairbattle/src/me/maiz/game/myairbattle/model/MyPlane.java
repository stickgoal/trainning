...
import me.maiz.game.myairbattle.factory.BulletFactory;
...
public class MyPlane {
	...
	private GamePlayingScreen playingPanel;
	private boolean flip;

	public MyPlane(GamePlayingScreen playingPanel) {
		this.isAlive = true;
		this.flip = true;
	...
	public GamePlayingScreen getPlayingPanel() {
		return playingPanel;
	}

	public void setPlayingPanel(GamePlayingScreen playingPanel) {
		this.playingPanel = playingPanel;
	}
}
